...
// Class allows the editing of events
public class EditingEventActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Get and set the current data

        Intent i = getIntent();
        final String type = i.getStringExtra("type");

        mCurrentDatabase = FirebaseDatabase.getInstance().getReference().child(type).child(eventID);

        mCurrentDatabase.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                //Sets data from the DB
                mEName.setText(dataSnapshot.child("name").getValue().toString());
                mEDesc.setText(dataSnapshot.child("desc").getValue().toString());
                mEYT.setText(dataSnapshot.child("trailerlink").getValue().toString());
                mEVenue.setText(dataSnapshot.child("venue").getValue().toString());

                startDateLabel.setText("Start Date:" + dataSnapshot.child("dateStart").getValue().toString());
                endDateLabel.setText("End Date:" + dataSnapshot.child("dateEnd").getValue().toString());

                weekdayTimesLabel.setText("Weekday Times:" + dataSnapshot.child("weekday").getValue().toString());
                weekendTimesLabel.setText("Weekend Times:" + dataSnapshot.child("weekend").getValue().toString());
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                mProgressDialog = new ProgressDialog(EditingEventActivity.this);
                                ...
                                public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> thumb_task) {
                                    ...
                                    if(thumb_task.isSuccessful()){
                                        ...
                                        final String type = i.getStringExtra("type");
                                            ...
                                            mEventDatabase = FirebaseDatabase.getInstance().getReference().child(type).child(eventID);
                                        ...
                                        mEventDatabase.setValue(eventMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                if (task.isSuccessful()){
                                                    ...
                                                    Toast.makeText(EditingEventActivity.this, "Uploaded.", Toast.LENGTH_LONG).show();
                                                }else{

                                                    Toast.makeText(EditingEventActivity.this, "Upload Error Encountered. Thumb", Toast.LENGTH_LONG).show();
                                        ...
                                        Toast.makeText(EditingEventActivity.this, "Upload Error Encountered.", Toast.LENGTH_LONG).show();
                                    }
